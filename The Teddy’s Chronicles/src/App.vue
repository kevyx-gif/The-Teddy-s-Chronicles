...
export default {
  ...
  methods: {
    setup() {
      ...
      sprite.x = 70;
      sprite.y = this.app.renderer.height - 120;
    ...
    update(delta) {
      ...
      if (this.sprite) {
        ...
        // Check if jumping
          ...
          if (this.sprite.y > this.app.renderer.height - this.sprite.height / 2) {
            this.sprite.y = this.app.renderer.height - this.sprite.height / 2;
